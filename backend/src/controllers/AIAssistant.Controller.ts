...
import { AIASSISTANTSERVICE_BACKEND_PATH, AIAssistantBackendService, MessageRequest, OAuthService } from "../protocol";
...
export class AIAssistantController {
  ...
  async generateReadME(req: Request, res: Response) {
    ...
    if (!project || !project.projectLeads.includes(user._id)) {
      throw new UnauthorizedException(`User ${user.login} is not a project lead of project ${project_name}`);
    }
